...
fetchPostsAnalytics();
  ...
  {engagement &&(
       ...
       <div className="flex items-center justify-center px-2 md:px-4 bg-violet-400 text-gray-800 text-sm md:text-base">
        ...
        <div className="flex items-center justify-between flex-1 p-3">
          <p className="text-2xl font-semibold">{engagement.total_blog_spaces}</p>
          <p>Total Spaces</p>
        </div>
       </div> 
       ...
       <div className="flex items-center justify-center px-2 md:px-4 bg-violet-400 text-gray-800 text-sm md:text-base">
        ...
        <div className="flex items-center justify-between flex-1 p-3">
          <p className="text-2xl font-semibold">{engagement.total_blog_posts}</p>
          <p>Total Post</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center px-2 md:px-4 bg-violet-400 text-gray-800 text-sm md:text-base">
        ...
        <div className="flex items-center justify-between flex-1 p-3">
          <p className="text-2xl font-semibold">{engagement.total_followers}</p>
          <p>Total Followers</p>
        </div>
      </div>
       ...
       <div className="flex items-center justify-center px-2 md:px-4 bg-violet-400 text-gray-800 text-sm md:text-base">
        ...
        <div className="flex items-center justify-between flex-1 p-3">
          <p className="text-2xl font-semibold">{engagement.total_comments}</p>
          <p>Total Comments</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center px-2 md:px-4 bg-violet-400 text-gray-800 text-sm md:text-base">
        ...
        <div className="flex items-center justify-between flex-1 p-3">
          <p className="text-2xl font-semibold">{engagement.total_shares}</p>
          <p>Total share</p>
        </div>
      </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
        ...
        <div className="flex items-center justify-between flex-1 p-3">
          <p className="text-2xl font-semibold">{engagement.total_love}</p>
          <p>Total love</p>
        </div>
      </div>
