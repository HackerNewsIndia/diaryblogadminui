    ...
    <div className="container">
            ...
            {engagement && (
              <>
                <div className="flex flex-wrap justify-center sm:justify-between justify-between">
                  <div className=" w-60 p-2 flex flex-row overflow-hidden rounded-lg bg-gray-900 text-gray-100 aspect-w-1 aspect-h-1">
                ...
                <div className="flex flex-wrap justify-center sm:justify-between justify-between">
                  <div className="w-60 p-2 flex flex-row overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                    <div className="flex items-center justify-center px-2 md:px-4 bg-violet-400 text-gray-800 text-sm md:text-base">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
      ...
      <section class="py-9 sm:py-12">
        ...
        <div class="flex flex-row flex-wrap mx-auto  justify-center ">
          <div className="flex flex-grow flex-col p-2 space-y-6 rounded shadow sm:p-8  overflow-auto">
            <div class="space-y-2">
      ...
      {latestPosts.length > 0 && (
        <section className="py-6 sm:py-12">
          <div className="container mx-auto max-w-screen-xl">
            ...
            <div className="flex flex-col  sm:flex-row sm:flex-wrap sm:justify-center sm:space-x-4 gap-4">
              {latestPosts.map((post) => (
                <article
                  key={post._id}
                  className="flex flex-col border-2 border-slate-200 rounded-md cursor-pointer"
                >
                  <img
                    src={post.imageUrl}
                    alt="image"
