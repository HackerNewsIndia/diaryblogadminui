  ...
  return (
    <div>
      <section className="py-20 dark:bg-gray-800 dark:text-gray-100">
        <div className="container px-4 mx-auto">
          ...
          <div className="  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 justify-center">
                        {engagement && (
              <>
                {/* <div className="flex flex-wrap justify-center sm:justify-between justify-between"> */}
                  <div className=" w-60 sm:w-60 p-2 flex flex-row overflow-hidden rounded-lg bg-gray-900 text-gray-100 aspect-w-1 aspect-h-1">
                ...
                {/* <div className="flex flex-wrap justify-center sm:justify-between justify-between"> */}
                  <div className="w-60 sm:w-60 p-2 flex flex-row overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                    <div className="flex items-center justify-center px-2 md:px-4 bg-violet-400 text-gray-800 text-sm md:text-base">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
      ...
      <section className="py-20 dark:bg-gray-800 dark:text-gray-100">
        <div className="container  px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-16 text-center">
            <span className="text-3xl font-semibold leadi text-center">Top</span>
          </div>
          ...
          {/* <div className="flex flex-wrap items-stretch -mx-4"> */}
			<div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					<div class="space-y-2">
						<h4 class="text-2xl font-bold">Most 3 Viewe</h4>
					</div>
          <article>
          <ul>
        {mostViewedPosts.map(post => (
          <li key={post.title}>
            <div class="flex items-center mt-8 space-x-4">
              <img src= {post.imageUrl || "https://source.unsplash.com/random/100x100/?5"} alt="" class="w-20 mb-4 h-18 sm:h-22 " />

              <div>
                <h2 class="text-xl md:text-xl font-bold">{post.title.substring(0, 18)} </h2>
                <h3 class="text-sm font-medium">{post.category}</h3>
                <time datetime="2021-02-18" class="text-sm dark:text-gray-400">{post.createDate
...
>
  ...
  <span>{post.views}</span> 
			...
			<div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					<div class="space-y-2">
						<h4 class="text-2xl font-bold">Most 3 Comments</h4>
...
? new Date( post.createDate ).toLocaleDateString() : "Loading..."}</time>
  ...
  <span>{post.views}</span> 
			...
			<div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					<div class="space-y-2">
						<h4 class="text-2xl font-bold">Most 3 Share</h4>
...
? new Date( post.createDate ).toLocaleDateString() : "Loading..."}</time>
  ...
  <span>{post.views}</span> 
        ...
        <div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
			<div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					<div class="space-y-2">
						<h4 class="text-2xl font-bold">Most 3 Love</h4>
...
? new Date( post.createDate ).toLocaleDateString() : "Loading..."}</time>
  ...
  <span>{post.views}</span> 
      ...
      <section className="py-20 dark:bg-gray-800 dark:text-gray-100">
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-16 text-center">
            <span className="text-3xl font-semibold leadi text-center">Least</span>
          </div>
       <div className="flex w-full flex-col-reverse mx-auto lg:flex-row ">
          {/* <div className="flex flex-wrap items-stretch -mx-4"> */}
			<div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					<div class="space-y-2">
						<h4 class="text-2xl font-bold">Least 3 Viewe</h4>
					</div>
          <article>
          <ul>
...
? new Date( post.createDate ).toLocaleDateString() : "Loading..."}</time>
  ...
  <span>{post.views}</span> 
			...
			<div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					<div class="space-y-2">
						<h4 class="text-2xl font-bold">Least 3 Comments</h4>
...
? new Date( post.createDate ).toLocaleDateString() : "Loading..."}</time>
  ...
  <span>{post.views}</span> 
			...
			<div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					<div class="space-y-2">
						<h4 class="text-2xl font-bold">Least 3 Share</h4>
...
? new Date( post.createDate ).toLocaleDateString() : "Loading..."}</time>
  ...
  <span>{post.views}</span> 
        ...
        <div class="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
			<div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					<div class="space-y-2">
						<h4 class="text-2xl font-bold">Least 3 Love </h4>
...
? new Date( post.createDate ).toLocaleDateString() : "Loading..."}</time>
  ...
  <span>{post.views}</span> 
      ...
      <section className="py-20 dark:bg-gray-800 dark:text-gray-100">
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-16 text-center">
            <span className="text-3xl font-semibold leadi text-center">Recently Posted</span>
          </div>
          <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
            {latestPosts.map((post) => (
              <article key={post._id} className="flex flex-col dark:bg-gray-900">
                <img
                  src={post.imageUrl || "https://source.unsplash.com/200x200/?fashion?1"}
                  alt="image"
...
? new Date( post.createDate ).toLocaleDateString() : "Loading..."}</span>
