  ...
  const handleAddToFollower = async () => {
    try {
      ...
      const response = await axios.post(
        `https://diaryblogapi-eul3.onrender.com/api/followers`,
        {
    ...
    const fetchFollowers = async () => {
      try {
        ...
        const response = await fetch(
          `https://diaryblogapi-eul3.onrender.com/api/followers/${blogSpaceId}/followers`
        );
        if (!response.ok) {
      ...
      <section className="py-9 sm:py-12 space-y-6">
                ...
                <div className="flex max-w-md overflow-hidden bg-white rounded-lg shadow-lg text-center">
                  <div className="w-1/3 bg-cover bg-landscape">
                    <img
                      ...
                      src={space.image_url || "default_image_url"}
                    />
                  </div>
        ...
        <div className="flex space-x-4 mb-4">
          ...
          <div className="flex space-x-2">
            <button className="btn btn-primary btn-xs" onClick={handleImport}>
              Import
            </button>
            ...
            <tbody>
              {followers.map((follower, index) => (
                ...
                >
                  ...
                  <td className="p-3">
                    {follower.email && typeof follower.email === "object"
