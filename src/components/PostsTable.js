...
const PostsTable = ({ selectedCompany, blog, startCreatingPost }) => {
 ...
 const handleEditBlog = (startCreatingPost) => {
  startCreatingPost();
...
useEffect(() => {
    ...
    <div class="flex flex-wrap items-stretch justify-center">
      <div class="flex flex-col space-y-1 items-center  ">
        ...
        <div class="flex max-w-md overflow-hidden bg-white rounded-lg shadow-lg text-center">
          ...
          <img alt="" className="object-cover w-full h-52" src={blogSpace.image_url || 'default_image_url'} />
          </div>
          <div class="w-2/3 p-4">
  ...
  <span>{blogSpace.views} k</span>
        ...
        <h1 class="text-3xl font-semibold leadi text-center">{posts.length} posts in 1 categories</h1>
...
<input
      ...
      /></div></div>
          <div class="flex flex-wrap items-start justify-center ">
            <button type="button" class="relative px-3 py-1 m-1 text-sm border rounded-md shadow-sm sm:py-2 sm:text-base ring ring-transparent group md:px-4 hover:ring hover:ring-opacity-50 focus:ring-opacity-50">Lifetyle</button>
            <button type="button" class="relative px-3 py-1 m-1 text-sm border rounded-md shadow-sm sm:py-2 sm:text-base ring ring-transparent group md:px-4 hover:ring hover:ring-opacity-50 focus:ring-opacity-50">Travel</button>
            <button type="button" class="relative px-3 py-1 m-1 text-sm border rounded-md shadow-sm sm:py-2 sm:text-base ring ring-transparent group md:px-4 hover:ring hover:ring-opacity-50 focus:ring-opacity-50">Food and Recipies</button>
            <button type="button" class="relative px-3 py-1 m-1 text-sm border rounded-md shadow-sm sm:py-2 sm:text-base ring ring-transparent group md:px-4 hover:ring hover:ring-opacity-50 focus:ring-opacity-50">Personal Finance</button>
            <button type="button" class="relative px-3 py-1 m-1 text-sm border rounded-md shadow-sm sm:py-2 sm:text-base ring ring-transparent group md:px-4 hover:ring hover:ring-opacity-50 focus:ring-opacity-50">Parenting and Family</button>
            <div>
            </div>
                    ...
                    <div>
                      <div className="flex flex-wrap justify-between">
                        <div className="flex space-x-2 text-sm dark:text-gray-400">
                          <button aria-label="Share this post" type="button" className="flex items-center p-1 space-x-2" onClick={() => handleEditBlog(startCreatingPost)}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current dark:text-violet-400">
                              <path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z"></path>
                            </svg>
                            <span> Edit </span>
          ...
          <div>
            <div class="flex flex-wrap justify-between">
              <div class="flex space-x-2 text-sm dark:text-gray-400">
                ...
                <button aria-label="Share this post" type="button" class="flex items-center p-1 space-x-2" onClick={() => handleEditBlog(startCreatingPost)}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 fill-current dark:text-violet-400">
                    <path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z"></path>
                  </svg>
                  <span>Edit</span>
    ...
    </div></div><div class="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8">
  <div class="space-y-2">
      ...
      <button aria-label="Share this post" type="button" class="flex items-center p-1 space-x-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 fill-current dark:text-violet-400">
          ...
          <span>View</span>
                ...
                <button aria-label="Bookmark this post" type="button" class="flex items-center p-1 space-x-1.5">
                ...
                <button type="button" class="flex items-center p-1 space-x-1.5">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of comments" class="w-4 h-4 fill-current dark:text-violet-400">
