    ...
    const fetchCommentsCount = async () => {
      try {
        const response = await fetch(
          ` https://typeit-api.onrender.com/blog_comments_count/${selectedTypeitSpace._id}`
        );
            ...
            <React.Fragment>
              <div>
                  ...
                  <section className="py-6">
                    <div className="container  mx-auto space-y-1 text-center">
                      <h1 className="text-3xl font-semibold leading text-center">
                        5 Spaces in 5 categories
                      </h1>

                      <div className="flex flex-wrap items-start justify-center">
                        <button className="relative px-8 py-3 text-lg font-semibold border rounded">
                          Let's Start a Space
                        </button>
                      </div>
                      ...
                      <div className="flex flex-wrap items-start justify-center">
                        <input
                          ...
                          className="w-32 py-2 pl-10 border-2 text-sm rounded-md sm:w-auto focus:outline-none text-black-100"
                          size="100"
                        />
                      </div>
                ...
                <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-2">
                  {companyData &&
                    companyData.map((blogSpace, index) => (
                      <article
                        key={blogSpace._id || blogSpace.name}
                        style={{ borderWidth: "1vh" }}
                        className="flex flex-col border-slate-200 rounded-md divide-slate-900 cursor-pointer"
                        onClick={() => handleCards(blogSpace)}
                      >
                            ...
                            <div className="mt-6 flex items-center space-x-4">
                              <div className="flex flex-col items-center">
                                ...
                                >
                                  ...
                                  <span>
                                    {" "}
                                    {followersCounts[blogSpace._id.$oid] ||
                                      0}{" "}
                                    followers
                                  </span>
                                </button>
                              ...
                              <div className="flex flex-col items-center">
                                <button
                                  type="button"
                                  className="flex items-center justify-center p-1 space-x-1.5"
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 512 512"
